...
// Use symmetry for optimization (comment out if not used)
// #define USE_SYMMETRY

// Number of random jumps
// Maximum value is 512 for the GPU
#define NB_JUMP 32

// GPU group size for thread organization
#define GPU_GRP_SIZE 256

// Number of runs per kernel call on the GPU
#define NB_RUN 16

// Kangaroo types
#define TAME 0   // Wild2 kangaroo
#define TAME1 1   // Wild2 kangaroo
#define WILD 0   // Wild2 kangaroo
#define WILD1 1   // Wild2 kangaroo
...
// SendDP period in seconds (data exchange period)
#define SEND_PERIOD 2.0

// Timeout in seconds before closing idle client connections
#define CLIENT_TIMEOUT 3600.0

// Number of partitions for the merge process
